...
#include "app.h"
// include IMU functions
#include <xc.h>           // processor SFR definitions
#include "INIT_COM.h"


// registers for IMU X and Y
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            if(appData.emulateMouse)
            {
                ...
                if(movement_length > 50)
                {
                    ...
                    // put accelerometer data here!!!
                    appData.xCoordinate =(int8_t)accX/100; //dir_table[vector & 0x07] ;
                    appData.yCoordinate =(int8_t)accY/100; //dir_table[(vector+2) & 0x07];
                    vector ++;
                    movement_length = 0;
                }
            }
