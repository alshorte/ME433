...
#pragma config FPLLIDIV = DIV_2 // divide input clock to be in range 4-5MHz (8 MHz clock -> divde by 2)
#pragma config FPLLMUL = MUL_24 // multiply clock after FPLLIDIV (24x multiplier -> 96 MHz)
#pragma config FPLLODIV = DIV_2 // divide clock after FPLLMUL to get 48MHz (2x divider -> 48 MHz)
